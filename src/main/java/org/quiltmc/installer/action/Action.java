...
public abstract class Action<M> {
	...
	public static InstallClient installClient(String minecraftVersion, @Nullable String loaderVersion, @Nullable String installDir, boolean generateProfile, boolean beaconOptOut) {
